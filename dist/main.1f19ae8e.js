...
var btnCreateNum = document.querySelector("#createNumber");
var btnCallNum = document.querySelector("#callNumber");
var spanNewNum = document.querySelector("#newNumber");
var spanQueue = document.querySelector("#queue");
var n = 0;
var queue = [];

btnCreateNum.onclick = function () {
  n += 1;
  queue.push(n);
